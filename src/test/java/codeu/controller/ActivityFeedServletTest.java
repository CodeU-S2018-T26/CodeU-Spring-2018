...
public class ActivityFeedServletTest 
{
	  ...
	  public void testDoGet() throws IOException, ServletException {
	    ...
	    User fakeUser1 = new User(fakeUser1Id,"user1","9dd32163318bf5624afd72990234ee99",fakeUser1Instant);
	    mockUserStore.addUser(fakeUser1);
	    UUID fakeUser2Id = UUID.randomUUID();
	    Instant fakeUser2Instant = Instant.now().plusSeconds(2000);
	    User fakeUser2 = new User(fakeUser2Id,"user2","c941dacea833ab8f740103b7ab17b436",fakeUser2Instant);
	    mockUserStore.addUser(fakeUser2);
	   
	    UUID fakeConversationId = UUID.randomUUID();
	    Instant fakeConversationInstant = Instant.now().plusSeconds(1500);
	    Conversation fakeConversation = new Conversation(fakeConversationId,fakeUser1Id,"conversationTitle", fakeConversationInstant);
	    ...
	    Message fakeMessage = new Message(fakeMessageId, fakeConversationId, fakeUser1Id, "messageContent", fakeMessageInstant);
	    ...
	    HashMap<Instant, HashMap<UUID, String>> fakeHashMap = new HashMap<Instant, HashMap<UUID, String>>();
	    ...
	    Mockito.when(mockActivityfeedServlet.buildHashMap(fakeConversations,fakeUsers,fakeMessages)).thenReturn(fakeHashMap);
