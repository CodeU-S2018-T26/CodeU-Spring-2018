...
public class ActivityFeedServlet extends HttpServlet {
	...
	/**
	 * This function takes in a list of conversations,users and messages and returns
	 * a HashMap of Instants mapping to HashMaps of UUIDs mapping to a data store:
	 * User,Conversation or Message
	 * 
	 * @param conversations
	 * @param users
	 * @param messages
	...
	/**
	 * This function takes in a HashMap and finds the earliest Instant using the
	 * isBefore function
	 * 
	 * @param hm
	 ...
	 * Stores Instants in correct order in an ArrayList
	 * 
	 * @param hm
